...
import { validateMp4Buffer, isFailureStatus, isSuccessStatus } from './_validation.ts'
...
// Runway MP4 validation helpers live in _validation.ts so unit tests can
// import them without booting the serve() handler.
